...
- **Rule:** If a criterion cannot be tested, it must be refined or removed.
- **Verify:** Use the Knowledge Graph to link elicitation manifests directly to test planning.
