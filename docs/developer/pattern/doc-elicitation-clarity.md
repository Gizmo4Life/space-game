...
- **Rule:** Avoid subjective terms like "fast", "easy", or "intuitive" without supporting metrics.
- **Verify:** Success criteria must be verifiable through automated or manual testing.
