...
- **Rule:** **Hull Production** (Shipyards) is biased by the maximum of **Aggression** and **Industrialism**.
- **Rule:** Gated by **Credits** and **Manufacturing Goods** (Costs scaled by Tier).
...
- Manufacturing Goods and Credits are correctly deducted from the faction's stockpile upon construction.
