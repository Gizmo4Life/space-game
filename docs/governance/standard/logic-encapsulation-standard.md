...
| :--- | :--- | :--- |
| [housekeeping-encapsulation](/docs/developer/pattern/housekeeping-encapsulation.md) | **P** | Preferred. Move repeated setup into a named private method on the class. |
| [inline-repeated-setup](#) | **D** | Deprecated. The same loop or lookup block appearing more than once in the same class. |
| [hardcoded-entity-id](#) | **U** | Unacceptable. Using a literal entity ID or bypassing standard registry views. |
...
| Pattern | Rating | Contextual Nuance |
| :--- | :--- | :--- |
| [centralized-entity-lookup](/docs/developer/pattern/centralized-entity-lookup.md) | **P** | Preferred. Use a shared utility (e.g., `UIUtils::findFlagship`, `ShipOutfitter::blueprintFromEntity`) as the single authority. |
| [blueprint-round-trip](/docs/developer/pattern/blueprint-round-trip.md) | **P** | Preferred. Any system that both applies and extracts blueprints must provide a round-trip symmetry test. |
