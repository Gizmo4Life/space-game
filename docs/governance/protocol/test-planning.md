...
- **Action:** Specify the target coverage percentage or critical path verification points.
- **Verify:** Acceptance criteria are documented in the task or implementation plan.
